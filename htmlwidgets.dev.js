...
var PROTO = 'prototype', ID = 0, $ = jQuery, htmlwidget = {VERSION: '0.9.0', widget: {}, locale: {}, _handle: {}},
...
htmlwidget._handle['datatable'] = function( type, el, opts, pre_init, post_init ) {
    ...
    var dt_pagination = dt_wrapper.find('.dataTables_length select').htmlwidget('dropdown'),
