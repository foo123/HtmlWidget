...
var jbImagesDialog = {
	...
	inProgress : function() {
		...
		this.timeoutStore = window.setTimeout(function(){
			document.getElementById("upload_additional_info").innerHTML = tinymce.utils.i18n.translate('This is taking longer than usual.') + '<br />' + tinymce.utils.i18n.translate('An error may have occurred.') + '<br /><a href="#" onClick="jbImagesDialog.showIframe()">' + tinymce.utils.i18n.translate('View script\'s output') + '</a>';
