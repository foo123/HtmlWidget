...
<head>
    ...
    <title>HtmlWidgets Bootstrap Components Test page (v.<?php echo HtmlWidget::VERSION; ?>)</title>
</head>
<body style="padding:10px 20px">
    <span id="forkongithub"><a href="https://github.com/foo123/HtmlWidget">Find me on GitHub</a></span>
    <h1>HtmlWidgets Bootstrap Components Test page (v.<?php echo HtmlWidget::VERSION; ?>)</h1>
    
<h2>Buttons</h2>
<hr />

<?php widget('button', array('framework'=>'bootstrap','icon'=>'info-circle'),array('text'=>'Button')); ?>
<?php widget('button', array('framework'=>'bootstrap','icon'=>'info-circle','class'=>'btn-primary'),array('text'=>'Button')); ?>
<?php widget('button', array('framework'=>'bootstrap','iconr'=>'info-circle','class'=>'btn-secondary'),array('text'=>'Button')); ?>
<?php widget('button', array('framework'=>'bootstrap','iconr'=>'info-circle','class'=>'btn-secondary btn-lg'),array('text'=>'Button')); ?>
<?php widget('button', array('framework'=>'bootstrap','iconr'=>'info-circle','class'=>'btn-primary btn-lg'),array('text'=>'Button')); ?>
...
<h2>Select Boxes</h2>
<hr />
<?php widget('selectbox',array('framework'=>'bootstrap','placeholder'=>'Select..'),array('options'=>array(
array('key1','option1'),
array('key2','option2'),
array('key3','option3'),
))); ?>
